...
import { createNewExam, getAllExams, removeExam, updateExam } from '../services/examService.js';
...
router.put('/api/exams/:id', async (req: Request, res: Response) => {
  try {
...
router.delete('/api/exams/:id', async (req: Request, res: Response) => {
  try {
    const id = parseInt(req.params.id as string, 10);
